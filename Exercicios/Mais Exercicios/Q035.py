"""Questão 35: Defina uma função que possa gerar um dicionário onde as chaves sejam números entre 1 e 20 (ambos incluídos) e os valores sejam quadrados de chaves. A função deve imprimir apenas os valores.
